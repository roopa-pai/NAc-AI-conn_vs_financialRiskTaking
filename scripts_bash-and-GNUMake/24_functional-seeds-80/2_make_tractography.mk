...
#(8a) ring0 ("real") ROIs
ROIs/LNAcc_ring0.nii.gz: /mnt/tpp/risktaking/roopa/MScThesis/lib/f_ROIs/thrsh_L_NAcc.nii.gz DTI_fit_FA.nii.gz T1toStdSpc1Warp.nii.gz DTItoT11Warp.nii.gz
	mkdir -p ROIs ;\
	T1toStdSpc=`basename $(word 3, $^) 1Warp.nii.gz` ;\
	DTItoT1=`basename $(word 4, $^) 1Warp.nii.gz` ;\
	WarpImageMultiTransform 3 $< $@ -R $(word 2,$^) -i $${T1toStdSpc}0GenericAffine.mat $${T1toStdSpc}1InverseWarp.nii.gz -i $${DTItoT1}0GenericAffine.mat $${DTItoT1}1InverseWarp.nii.gz ;\
	fslmaths $@ -bin $@

ROIs/RNAcc_ring0.nii.gz: /mnt/tpp/risktaking/roopa/MScThesis/lib/f_ROIs/thrsh_R_NAcc.nii.gz DTI_fit_FA.nii.gz T1toStdSpc1Warp.nii.gz DTItoT11Warp.nii.gz
	mkdir -p ROIs ;\
	T1toStdSpc=`basename $(word 3, $^) 1Warp.nii.gz` ;\
	DTItoT1=`basename $(word 4, $^) 1Warp.nii.gz` ;\
	WarpImageMultiTransform 3 $< $@ -R $(word 2,$^) -i $${T1toStdSpc}0GenericAffine.mat $${T1toStdSpc}1InverseWarp.nii.gz -i $${DTItoT1}0GenericAffine.mat $${DTItoT1}1InverseWarp.nii.gz ;\
...
ROIs/LAI_ring0.nii.gz: /mnt/tpp/risktaking/roopa/MScThesis/lib/f_ROIs/thrsh_L_AI.nii.gz DTI_fit_FA.nii.gz T1toStdSpc1Warp.nii.gz DTItoT11Warp.nii.gz
	mkdir -p ROIs ;\
	T1toStdSpc=`basename $(word 3, $^) 1Warp.nii.gz` ;\
	DTItoT1=`basename $(word 4, $^) 1Warp.nii.gz` ;\
	WarpImageMultiTransform 3 $< $@ -R $(word 2,$^) -i $${T1toStdSpc}0GenericAffine.mat $${T1toStdSpc}1InverseWarp.nii.gz -i $${DTItoT1}0GenericAffine.mat $${DTItoT1}1InverseWarp.nii.gz ;\
...
ROIs/RAI_ring0.nii.gz: /mnt/tpp/risktaking/roopa/MScThesis/lib/f_ROIs/thrsh_R_AI.nii.gz DTI_fit_FA.nii.gz T1toStdSpc1Warp.nii.gz DTItoT11Warp.nii.gz
	mkdir -p ROIs ;\
	T1toStdSpc=`basename $(word 3, $^) 1Warp.nii.gz` ;\
	DTItoT1=`basename $(word 4, $^) 1Warp.nii.gz` ;\
	WarpImageMultiTransform 3 $< $@ -R $(word 2,$^) -i $${T1toStdSpc}0GenericAffine.mat $${T1toStdSpc}1InverseWarp.nii.gz -i $${DTItoT1}0GenericAffine.mat $${DTItoT1}1InverseWarp.nii.gz ;\
